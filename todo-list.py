...
def menu():
    ...
    while True:
        ...
        if wybor == '1':
            ...
            zadanie_id = int(input("Podaj ID zadania do wyświetlenia: "))
            zadanie = next((z for z in zadania if z['id'] == zadanie_id), None)
            if zadanie:
                wyswietl_zadanie(zadanie, pokaz_opis=True)
            else:
                print("Nie znaleziono zadania o podanym ID.")
        elif wybor == '3':
            ...
            zadanie_id = int(input("Podaj ID zadania do aktualizacji: "))
